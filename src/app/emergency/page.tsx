          ...
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 z-10">
              ...
              <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-on-surface mb-8 leading-[1.1]">
                ...
                <span className="text-on-tertiary-container text-4xl md:text-5xl opacity-90 italic">Rapid Response in Under 60 Minutes</span>
              </h1>
              ...
              <div className="bg-primary-container p-1 rounded-xl ambient-shadow max-w-md group overflow-hidden transition-all duration-300">
                <div className="bg-surface-container-lowest p-6 rounded-[0.5rem] flex flex-col sm:flex-row items-center gap-6">
                  ...
                  <div className="text-center sm:text-left">
                    ...
                    <a className="block text-3xl font-black text-on-surface hover:text-on-tertiary-container transition-colors" href="tel:1800GUARDIAN">
                      1-800-GUARDIAN
                    </a>
                  </div>
                </div>
            ...
            <div className="lg:col-span-5 relative">
              <div className="aspect-square relative z-10 rounded-2xl overflow-hidden ambient-shadow">
                <img
                  ...
                  alt="Modern high-tech server room with emergency lighting"
        ...
        <section className="py-24 bg-surface-container-low">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-on-surface mb-4">Critical Response Coverage</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-surface-container-lowest p-8 rounded-xl ghost-border hover:bg-white transition-all duration-300">
                <div className="mb-6 flex justify-between items-start">
                  ...
                  <span className="text-[0.65rem] font-bold tracking-tighter text-on-primary-container bg-surface-container px-2 py-1 rounded uppercase">Priority 0</span>
                </div>
                <h3 className="text-xl font-bold text-on-surface mb-4">Cybersecurity Breaches</h3>
              ...
              <div className="bg-surface-container-lowest p-8 rounded-xl ghost-border hover:bg-white transition-all duration-300">
                <div className="mb-6 flex justify-between items-start">
                  ...
                  <span className="text-[0.65rem] font-bold tracking-tighter text-on-primary-container bg-surface-container px-2 py-1 rounded uppercase">Critical</span>
                </div>
                <h3 className="text-xl font-bold text-on-surface mb-4">Server & Cloud Failures</h3>
              ...
              <div className="bg-surface-container-lowest p-8 rounded-xl ghost-border hover:bg-white transition-all duration-300">
                <div className="mb-6 flex justify-between items-start">
                  ...
                  <span className="text-[0.65rem] font-bold tracking-tighter text-on-primary-container bg-surface-container px-2 py-1 rounded uppercase">Restoration</span>
                </div>
                <h3 className="text-xl font-bold text-on-surface mb-4">Massive Data Loss</h3>
        ...
        <section className="py-32 relative overflow-hidden bg-surface">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-24">
              <h2 className="text-4xl font-bold text-on-surface tracking-tight">Deployment Protocol</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-16 relative">
              ...
              <div className="relative z-10 flex flex-col items-center text-center">
                <div className="w-20 h-20 rounded-full bg-primary-container text-white flex items-center justify-center text-2xl font-black mb-8 ambient-shadow">01</div>
                <h4 className="text-xl font-bold text-on-surface mb-3 uppercase tracking-wider">Initial Call</h4>
              ...
              <div className="relative z-10 flex flex-col items-center text-center">
                <div className="w-20 h-20 rounded-full bg-tertiary-fixed text-on-tertiary-container flex items-center justify-center text-2xl font-black mb-8 ambient-shadow">02</div>
                <h4 className="text-xl font-bold text-on-surface mb-3 uppercase tracking-wider">Rapid Diagnose</h4>
              ...
              <div className="relative z-10 flex flex-col items-center text-center">
                <div className="w-20 h-20 rounded-full bg-on-tertiary-container text-white flex items-center justify-center text-2xl font-black mb-8 ambient-shadow">03</div>
                <h4 className="text-xl font-bold text-on-surface mb-3 uppercase tracking-wider">Full Resolve</h4>
        ...
        <section className="pb-24 bg-surface">
          <div className="max-w-5xl mx-auto px-6">
            <div className="bg-tertiary-fixed/90 backdrop-blur-xl p-8 md:p-12 rounded-2xl flex flex-col md:flex-row items-center gap-8 ambient-shadow border border-on-tertiary-fixed/10">
              ...
              <button className="bg-on-tertiary-container text-white font-bold py-4 px-8 rounded-lg shadow-lg active:scale-95 transition-all shrink-0 uppercase tracking-tight">
                Get Immediate Help
              </button>
            </div>
          </div>
