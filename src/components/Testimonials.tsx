      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-surface-container-lowest p-10 rounded-2xl relative">
            ...
            <p className="text-lg font-medium text-on-surface-custom mb-8 relative z-10 italic">"When our primary data center went down at 2 AM on a Sunday, Digital Guardian had us back online before our internal team even woke up. Their response speed is unreal."</p>
