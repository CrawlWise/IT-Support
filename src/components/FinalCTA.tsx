  ...
  return (
    <section className="py-24 bg-primary-container-custom text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
        ...
        <p className="text-xl text-on-primary-container mb-10 max-w-2xl mx-auto">Digital emergencies don't respect office hours. Secure your peace of mind with the OutOfHours IT Support team today.</p>
