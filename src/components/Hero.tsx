      ...
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-16">
        <div className="flex-1 text-left z-10">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link href="/services">
              <Button variant="outline" className="border border-outline-variant/20 bg-surface-container-lowest text-on-surface-custom px-8 py-4 h-auto rounded-md font-bold text-lg hover:bg-surface-container-low transition-all">
                View Services
              </Button>
            </Link>
          </div>
        ...
        <div className="flex-1 relative">
          ...
          <div className="relative aspect-[4/5] rounded-2xl overflow-hidden shadow-2xl">
            <img
              ...
              alt="Modern high-tech server room with deep blue ambient lighting and neon accents reflecting on metallic surfaces, ultra-clean professional look"
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-primary-container-custom/60 to-transparent"></div>
            ...
            <div className="absolute bottom-6 left-6 right-6 guardian-glass p-4 rounded-xl shadow-lg border border-white/20">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-on-surface-custom">Under 12 Minutes</p>
                </div>
              </div>
            </div>
          </div>
